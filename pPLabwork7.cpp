...
int main()
{
    ...
    while (iterator > 2)    //The iterator will always be true and the loop will always start because iterator = 3   
    {
        cin >> input;
        if (input == 1)                     //if input is = 1, the Standard HOME PC is chosen and objects printed
        {
            ...
            cout << setw(40) << left << "\t" << "STANDARD HOME PC" << endl << endl;
            cout << "CPU:" << setw(13) << left << " " << homePC.cpu << endl << endl;
            cout << "RAM:" << setw(13) << left << " " << homePC.ram << endl << endl;
            cout << "MEMORY(SSD):" << setw(5) << left << " " << homePC.ssd << endl << endl;
            cout << "GPU:" << setw(13) << left << " " << homePC.gpu << endl << endl;
            cout << "PSU:" << setw(13) << left << " " << homePC.psu << endl << endl;
            cout << "CASE:" << setw(12) << left << " " << homePC.cAse << endl << endl;
            cout << "MOTHERBOARD:" << setw(5) << left << " " << homePC.mb << endl << endl;
        ...
        else if (input == 2)                //if input is = 2, the Standard OFFICE PC is chosen and objects printed
        {
            ...
            cout << setw(40) << left << "\t" << "STANDARD OFFICE PC" << endl << endl;
            cout << "CPU:" << setw(13) << left << " " << officePC.cpu << endl << endl;
            cout << "RAM:" << setw(13) << left << " " << officePC.ram << endl << endl;
            cout << "MEMORY(SSD):" << setw(5) << left << " " << officePC.ssd << endl << endl;
            cout << "GPU:" << setw(13) << left << " " << officePC.gpu << endl << endl;
            cout << "PSU:" << setw(13) << left << " " << officePC.psu << endl << endl;
            cout << "CASE:" << setw(12) << left << " " << officePC.cAse << endl << endl;
            cout << "MOTHERBOARD:" << setw(5) << left << " " << officePC.mb << endl << endl;
            iterator = 1;                   //iterator is now = 1, and the while loop will end because condition will not be valid again
        }
        else if (input == 3)                //if input is = 3, the Standard GAMING PC is chosen and objects printed
        {
            ...
            cout << setw(40) << left << "\t" << "GOOD GAMING PC" << endl << endl;
            cout << "CPU:" << setw(13) << left << " " << gamingPC.cpu << endl << endl;
            cout << "RAM:" << setw(13) << left << " " << gamingPC.ram << endl << endl;
            cout << "MEMORY(SSD):" << setw(5) << left << " " << gamingPC.ssd << endl << endl;
            cout << "GPU:" << setw(13) << left << " " << gamingPC.gpu << endl << endl;
            cout << "PSU:" << setw(13) << left << " " << gamingPC.psu << endl << endl;
            cout << "CASE:" << setw(12) << left << " " << gamingPC.cAse << endl << endl;
            cout << "MOTHERBOARD:" << setw(5) << left << " " << gamingPC.mb << endl << endl;
            iterator = 1;                   //iterator is now = 1, and the while loop will end because condition will not be valid again
        }
        else
        {
